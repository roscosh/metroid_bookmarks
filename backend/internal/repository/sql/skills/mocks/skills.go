...
//
//	mockgen -source=./internal/repository/sql/skills/skills.go -destination=./internal/repository/sql/skills/mocks/skills.go
//

// Package mock_skills is a generated GoMock package.
package mock_skills

import (
	skills "metroid_bookmarks/internal/repository/sql/skills"
	reflect "reflect"
...
func (m *MockSQL) Create(createForm *skills.CreateSkill) (*skills.Skill, error) {
	m.ctrl.T.Helper()
...
func (m *MockSQL) Delete(id int) (*skills.Skill, error) {
	m.ctrl.T.Helper()
...
func (m *MockSQL) Edit(id int, editForm *skills.EditSkill) (*skills.Skill, error) {
	m.ctrl.T.Helper()
...
func (m *MockSQL) GetAll() ([]skills.Skill, error) {
	m.ctrl.T.Helper()
...
func (m *MockSQL) GetByID(id int) (*skills.Skill, error) {
	m.ctrl.T.Helper()
