...
//
//	mockgen -source=./internal/repository/sql/rooms/rooms.go -destination=./internal/repository/sql/rooms/mocks/rooms.go
//

// Package mock_rooms is a generated GoMock package.
package mock_rooms

import (
	rooms "metroid_bookmarks/internal/repository/sql/rooms"
	reflect "reflect"
...
func (m *MockSQL) Create(createForm *rooms.CreateRoom) (*rooms.Room, error) {
	m.ctrl.T.Helper()
...
func (m *MockSQL) Delete(id int) (*rooms.Room, error) {
	m.ctrl.T.Helper()
...
func (m *MockSQL) Edit(id int, editForm *rooms.EditRoom) (*rooms.Room, error) {
	m.ctrl.T.Helper()
...
func (m *MockSQL) GetAll() ([]rooms.Room, error) {
	m.ctrl.T.Helper()
...
func (m *MockSQL) GetByID(id int) (*rooms.Room, error) {
	m.ctrl.T.Helper()
